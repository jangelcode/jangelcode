...
// Define a stateful widget for creating a new group
class CreateNewGroup extends StatefulWidget {
  @override
  NewClass createState() => NewClass();
}

// List of interest widgets
...
// Define the state for the CreateNewGroup widget
class NewClass extends State<CreateNewGroup> {
  // Dropdown menu options for preferred group size
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: new AppBar(
        // App bar for the create new group screen
        ...
        children: <Widget>[
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                // Divider and button for selecting interests
                ...
                Divider(color: Colors.white, height: 0),
                // Button for personality test answers
                Container(
                    height: 60,
                    child: FlatButton(
                      child: Row(
                ...
                // Dropdown for preferred group size
                ...
                // Animated opacity for additional questions based on student status
                AnimatedOpacity(
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.end,
                    children: <Widget>[
                      Container(
                          ...
                          child: AutoSizeText('Would you like to find other students at your university?', style: TextStyle(fontSize: 16, color: Colors.white))),
                      Padding(padding: EdgeInsets.all(10)),
                      Text('Yes', style: TextStyle(fontSize: 16.0, color: Colors.white)),
                      Radio(
                        activeColor: Colors.black,
                ...
                Padding(padding: EdgeInsets.all(4)),
                // Animated opacity for university input field
                AnimatedOpacity(
                  child: Center(
                    child: Container(
                        height: 40,
                ...
                Center(
                  ...
                  width: 150,
                  child: RaisedButton(
                    child: Text('Search', style: TextStyle(color: Colors.blue[700])),
